#' @title Load region cities from the city_shape_extract.R output
#'
#' @description
#' Parse the JSON produced by [extract_city_df()] (see `city_shape_extract.R`)
...
#'
#' @param city_json A JSON string as returned by [extract_city_df()], or a
...
#'
#' @description
#' Join the region's destination cities (from [extract_city_df()]) with the
